...
$ARGV[0] or die "use plotPieNR.pl DATA.csv\n";
...
colors   = c(dna.pal(17), "magenta", ltr.pal(10), line.pal(13), "gray30", "gray50", sine.pal(15), "grey60", "grey80", sat.pal(7), "chocolate4", "azure4") 

# output file
png("$name.pie2.png", height = 400, width = 400)

# plot!
pie(as.matrix(data), col=colors, border = NA, labels = NA, main = "$name")
# legend
